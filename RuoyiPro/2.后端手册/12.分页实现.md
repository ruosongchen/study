...
## [#](https://doc.iocoder.cn/page-feature/#_1-前端分页实现)1. 前端分页实现

### [#](https://doc.iocoder.cn/page-feature/#_1-1-vue-界面)1.1 Vue 界面

界面 [`tenant/index.vue` (opens new window)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-ui-admin/src/views/system/tenant/index.vue)相关的代码如下：
...
### [#](https://doc.iocoder.cn/page-feature/#_1-2-api-请求)1.2 API 请求

请求 [`system/tenant.js` (opens new window)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-ui-admin/src/api/system/tenant.js)相关的代码如下：
...
## [#](https://doc.iocoder.cn/page-feature/#_2-后端分页实现)2. 后端分页实现

### [#](https://doc.iocoder.cn/page-feature/#_2-1-controller-接口)2.1 Controller 接口
...
#### [#](https://doc.iocoder.cn/page-feature/#_2-1-1-分页参数-pageparam)2.1.1 分页参数 PageParam
...
#### [#](https://doc.iocoder.cn/page-feature/#_2-1-2-分页结果-pageresult)2.1.2 分页结果 PageResult
...
### [#](https://doc.iocoder.cn/page-feature/#_2-2-mapper-查询)2.2 Mapper 查询
