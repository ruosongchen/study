...
![Linux 部署](https://doc.iocoder.cn/img/Linux%E9%83%A8%E7%BD%B2/01.png)

## [#](https://doc.iocoder.cn/deployment-linux/#_1-配置-mysql)1. 配置 MySQL

### [#](https://doc.iocoder.cn/deployment-linux/#_1-1-安装-mysql-可选)1.1 安装 MySQL（可选）
...
### [#](https://doc.iocoder.cn/deployment-linux/#_1-2-导入-sql-脚本)1.2 导入 SQL 脚本
...
## [#](https://doc.iocoder.cn/deployment-linux/#_2-配置-redis)2. 配置 Redis
...
## [#](https://doc.iocoder.cn/deployment-linux/#_3-部署后端)3. 部署后端

### [#](https://doc.iocoder.cn/deployment-linux/#_3-1-修改配置)3.1 修改配置
...
### [#](https://doc.iocoder.cn/deployment-linux/#_3-2-编译后端)3.2 编译后端
...
### [#](https://doc.iocoder.cn/deployment-linux/#_3-3-上传-jar-包)3.3 上传 Jar 包
...
### [#](https://doc.iocoder.cn/deployment-linux/#_3-4-编写脚本)3.4 编写脚本
...
### [#](https://doc.iocoder.cn/deployment-linux/#_3-5-启动后端)3.5 启动后端
...
## [#](https://doc.iocoder.cn/deployment-linux/#_4-部署前端)4. 部署前端

### [#](https://doc.iocoder.cn/deployment-linux/#_4-1-修改配置)4.1 修改配置
...
### [#](https://doc.iocoder.cn/deployment-linux/#_4-2-编译前端)4.2 编译前端
...
### [#](https://doc.iocoder.cn/deployment-linux/#_4-3-上传-dist-文件)4.3 上传 `dist` 文件

在 Linux 服务器上创建 `/work/projects/yudao-ui-admin` 目录，使用 `scp` 命令或者 FTP 工具，将 `dist` 上传到该目录下。如下图所示：

![上传  文件](https://doc.iocoder.cn/img/Linux%E9%83%A8%E7%BD%B2/13.png)

### [#](https://doc.iocoder.cn/deployment-linux/#_4-4-启动前端)4.4 启动前端？

前端无法直接启动，而是通过 Nginx 转发读取 `/work/projects/yudao-ui-admin` 目录的静态文件。

## [#](https://doc.iocoder.cn/deployment-linux/#_5-配置-nginx)5. 配置 Nginx

### [#](https://doc.iocoder.cn/deployment-linux/#_5-1-安装-nginx)5.1 安装 Nginx
...
### [#](https://doc.iocoder.cn/deployment-linux/#_5-2-方式一-服务器-ip-访问)5.2 方式一：服务器 IP 访问
...
### [#](https://doc.iocoder.cn/deployment-linux/#_5-3-方式二-独立域名访问)5.3 方式二：独立域名访问
